...
//get User
  ...
  Future<http.Response> commentLike(
      String userId, String videoId, String commentId) async {
    var url = Uri.parse(Constraints.MANAGE_URL);
    return await http.post(url, body: {
      "user_id": userId,
      "video_id": videoId,
  ...
  Future<http.Response> recomment(
      String userId, String comment, String commentId) async {
    var url = Uri.parse(Constraints.MANAGE_URL);
    return await http.post(url, body: {
      "user_id": userId,
      "comment": comment,
